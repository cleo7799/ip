...
public class Parser {
     ...
     *
     * @param fullCommand The full user command string (e.g., "todo Buy groceries", "mark 1").
     ...
     * @throws DateTimeException if date-time parsing fails (for date-related commands).
     * @throws DateTimeParseException if the date-time format is incorrect (for date-related commands).
     */
